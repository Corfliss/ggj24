...
# Initialize variable for BPM in the game
const MUSIC_PLAYLIST_100_BPM = 100
const MUSIC_PLAYLIST_80_BPM = 130
const MUSIC_PLAYLIST_60_BPM = 150
const MUSIC_PLAYLIST_40_BPM = 170
const MUSIC_PLAYLIST_20_BPM = 190
...
func _process(_delta):
	print(Wwise.get_source_play_position(music_playlist, false))
	# print(Wwise.get_rtpc_value_id($"../"))
